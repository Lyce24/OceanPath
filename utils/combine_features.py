...
def manage_feature(major_dir, aggregation, encoder: str, precision: int = 16, method: str = "mmap"):
    """
    ...
    combined_feature_dir = f"./combined_features/{major_dir}/features_{encoder}"
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", type=int, default=16, help="Precision for memory-mapped files (16 or 32)")
    parser.add_argument("-d", type=str, default="./bladder_features/", help="Major directory for features")
    ...
    manage_feature(major_dir, aggregation, encoder, precision=precision, method=method)