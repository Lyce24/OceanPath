"""
Model finalization after cross-validation (Phase 2 of Stage 4).
...
════════════════════════════════════════════════════════════════════════════
  ...
  Stage 5 reads info.json to know HOW to load and run inference:
...
def _save_ensemble(
    ...
    Stage 5 loads each, runs inference, and averages softmax probabilities.
    """
    t = cfg.training
    ...
    info = {
        ...
        "folds": fold_details,
        # Stage 5 needs these to reconstruct model architecture
